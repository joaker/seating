...
const Main = (props) => (
  ...
  <p style={pstyle}>
    ...
    <p style={pstyle}>
      On the <Link to={`/Guests`}>View Guests Page</Link>, you can see a list of all the guests currently available.  Click on a guest's name to see who they do and do not get along with
    </p>
