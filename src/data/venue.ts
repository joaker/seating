import { OptimizationMode, ModePart } from '../app/types';
...
export const seatsPerTableValues: number[] = [2, 3, 4, 6, 8, 9, 10, 12, 16, 25, 50, 100];

export const layoutDimensions = { rowCount, columnCount: tablesPerRow };

export const maxScore = 100;

export const toTemperature = (size: number): number => Math.pow(10, size);
export const toSize = (temperature: number): number => Math.log10(temperature);
